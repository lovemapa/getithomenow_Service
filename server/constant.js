let constant = {
    ...
    MISSINGPARAMSORFILES: 'Provide both userId and password',
    MISSINGUSERIDEMAIL: "Please provide either userId or email",
    ...
    INFLUENCECREATED: "Influence account created",
    CHARITYCREATED: "charity account created",
    TRUE: true,
    FALSE: false,
    ...
    NOTREGISTERED: 'This userId is not registered with any account',
    ...
    EXISTSMSG: 'Email or userId associated with another account',
    UNIQUEEMAILANDUSERNAME: 'Email or user ID already taken , Provide unique email and phone',
    VERIFYPENDING: 'Your account verification pending.',
    REQUIRECTEGORY: "EIther category name or main category is missing",
